...
export const TEAMS = {
  blue: {
    ...
    // `tone` names an entry in components/ui/tokens.js. The ten literal class
    // strings that used to live here -- lobbyPanel, lobbyAvatar, lobbyYouBadge
    // and the rest -- were component styling in a constants file, and they are
    // what let blue and red drift apart (red's dot was a shade darker than
    // blue's, red's avatar sat on white where blue's sat on near-black).
    tone: 'team-blue',
    badgeBg: 'bg-team-blue/15 text-team-blue border-team-blue/40',
    primaryBg: 'bg-team-blue',
    text: 'text-team-blue',
    baseLabel: 'West base',
  },
  red: {
    ...
    tone: 'team-red',
    badgeBg: 'bg-team-red/15 text-team-red border-team-red/40',
    primaryBg: 'bg-team-red',
    text: 'text-team-red',
    baseLabel: 'East base',
  },
}
